...
export default {
  ...
  methods: {
    init () {
      let ticketTimeOption = dataConfig.INIT_OPTION
    ...
    getQueryParams () {
      ...
      this.$store.commit('INIT_ANALYSIS_PROPERTY', { key: 'ticketTimeOption', data: dataConfig['INIT_OPTION'] })
